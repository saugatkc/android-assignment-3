package com.example.esoftwarica_saugat.AddStudent;
...
import com.example.esoftwarica_saugat.HomeActivity;
import com.example.esoftwarica_saugat.Model.Students;
import com.example.esoftwarica_saugat.R;
...
public class AddStudentFragment extends Fragment {
   ...
   //List<Students> studentsList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final int[] image = {R.drawable.male, R.drawable.female, R.drawable.other};
